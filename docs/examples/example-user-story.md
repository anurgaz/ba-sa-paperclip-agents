...
**So that** мерчант может начать принимать карточные платежи через платформу Flowlix в течение 48 часов.

### Context
- Flowlix работает по PayFac модели (ADR-001): мерчанты регистрируются как суб-мерчанты
